...
function incrementarPorUno(array) { // tres soluciones
...
for (var i = 0; i < array.length; i++) {
  nuevoArray[i] = array[i] + 1;    // ó  arrayNuevo.push(array[i] + 1) 
                                   // ó    array[i]= array[i]+1
                                    //      }  return array }
}
return nuevoArray;
...
function breakStatement(numero) {
  ...
  if (nuevoArray.length < 10){ return "Se interrumpió la ejecución"} else { return nuevoArray }
}
